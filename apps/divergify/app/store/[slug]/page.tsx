...
return (<div><h1>{p.title}</h1><p>{p.description}</p><p>${(p.priceCents/100).toFixed(2)}</p><form action="/api/checkout" method="POST"><input type="hidden" name="slug" value={p.slug}/><button type="submit">Buy</button></form></div>); }
